...
- technical writers adding new canonical knowledge objects
- support managers auditing the knowledge tree and knowledge-object coverage
...
- Knowledge pages exposed raw metadata but did not surface applicability, inbound links, or likely adjacent content clearly.
...
1. Extend the static site generator to add role-based landing pages and a faceted explorer driven by canonical source metadata.
2. Improve knowledge pages with faster operational summaries, stronger connected-content navigation, and lifecycle visibility.
3. Add generated manager and audit surfaces for the knowledge tree, coverage matrix, and content-health gaps.
4. Extend `new_article.py` to expose taxonomy values, prefill discovery metadata, and warn about duplicate or isolated-object risk earlier.
