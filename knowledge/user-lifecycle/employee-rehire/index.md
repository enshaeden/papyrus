---
id: kb-user-lifecycle-employee-rehire-index
title: User Lifecycle / Employee Rehire
canonical_path: knowledge/user-lifecycle/employee-rehire/index.md
summary: Collection index for curated seed content under User Lifecycle / Employee Rehire.
...
related_runbooks:
- kb-user-lifecycle-employee-rehire-re-hire-account-setup-process-for-it
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `user-lifecycle/employee-rehire` content under the curated KMDB structure.

## Articles
- [Re-Hire Account Setup Process for IT](re-hire-account-setup-process-for-it.md)
