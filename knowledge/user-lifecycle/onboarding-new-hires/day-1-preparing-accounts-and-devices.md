...
summary: 'Tickets for new hires are generated per the New Hire Workflow Overview: <ONBOARDING_WORKFLOW> < <HR_SYSTEM> < <TICKETING_SYSTEM> Ticket (<QUEUE_NAME>) Management New Hire Workflow Overview: <ONBOARDING_WORKFLOW> < <HR_SYSTEM> < <TICKETING_SYSTEM> Ticket (<QUEUE_NAME>) Management'
type: onboarding
status: active
owner: service_owner
