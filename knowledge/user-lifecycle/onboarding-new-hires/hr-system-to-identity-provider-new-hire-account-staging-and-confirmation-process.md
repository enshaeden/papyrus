...
summary: 'New Hire Workflow Overview: <ONBOARDING_WORKFLOW> < <HR_SYSTEM> < <TICKETING_SYSTEM> Ticket
  (<QUEUE_NAME>) Management New Hire Workflow Overview: <ONBOARDING_WORKFLOW> < <HR_SYSTEM> < <TICKETING_SYSTEM>
