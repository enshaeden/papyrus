---
id: kb-user-lifecycle-job-and-org-change-index
title: User Lifecycle / Job and Org Change
canonical_path: knowledge/user-lifecycle/job-and-org-change/index.md
...
source_title: User Lifecycle / Job and Org Change
...
service_name: User Lifecycle / Job and Org Change
...
related_runbooks:
- kb-user-lifecycle-job-and-org-change-it-team-workflow-for-ticket-management-and-access-review
- kb-user-lifecycle-job-and-org-change-job-and-org-change-ticket-review-guide
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `user-lifecycle/job-and-org-change` content under the curated KMDB structure.

## Articles
- [IT Team Workflow for Ticket Management and Access Review](it-team-workflow-for-ticket-management-and-access-review.md)
- [Job and Org Change Ticket Review Guide](job-and-org-change-ticket-review-guide.md)
