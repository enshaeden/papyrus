---
id: kb-user-lifecycle-offboarding-and-termination-index
...
source_title: User Lifecycle / Offboarding and Termination
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `user-lifecycle/offboarding-and-termination` content under the curated KMDB structure.
...
- [Offboarding and Termination](offboarding-and-termination.md)
- [Termination Checklist Action items](termination-checklist-action-items.md)
