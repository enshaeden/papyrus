...
summary: This SOP defines how IT handles user access removal and asset retrieval when someone leaves the company, distinguishing between Immediate and Scheduled terminations and outlining SLAs and checklist items.
type: offboarding
status: active
owner: service_owner
