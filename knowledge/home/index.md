...
id: kb-home-index
title: Home
canonical_path: knowledge/home/index.md
summary: Collection index for curated seed content under Home.
...
source_title: <COMPANY_NAME> - IT Support Team Home
team: IT Operations
systems: []
tags: []
created: '2025-07-10'
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `home` content under the curated KMDB structure.
