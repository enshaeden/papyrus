---
id: kb-applications-index
title: Applications
canonical_path: knowledge/applications/index.md
summary: Collection index for curated seed content under Applications.
...
- kb-applications-business-apps-index
prerequisites:
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications` content under the curated KMDB structure.
...
## Child Collections
- [Applications / Access and License Management](access-and-license-management/index.md)
- [Applications / Business Apps](business-apps/index.md)
