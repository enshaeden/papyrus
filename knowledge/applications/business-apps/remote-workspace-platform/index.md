---
id: kb-applications-business-apps-remote-workspace-platform-index
title: Applications / Business Apps / <REMOTE_WORKSPACE_PLATFORM>
canonical_path: knowledge/applications/business-apps/remote-workspace-platform/index.md
...
source_title: Applications / Business Apps / <REMOTE_WORKSPACE_PLATFORM>
...
service_name: Applications / Business Apps / <REMOTE_WORKSPACE_PLATFORM>
...
- article_id: null
  ...
  integrity_hash: null
related_object_ids:
- kb-applications-business-apps-remote-workspace-platform-remote-workspace-platform-workplace-admin-guide
prerequisites:
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/business-apps/<REMOTE_WORKSPACE_PLATFORM>` content under the curated KMDB structure.

## Articles
- [<REMOTE_WORKSPACE_PLATFORM> Administration Guide](remote-workspace-platform-workplace-admin-guide.md)
