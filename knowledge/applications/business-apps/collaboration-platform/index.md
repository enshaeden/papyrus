---
id: kb-applications-business-apps-collaboration-platform-index
title: Applications / Business Apps / <COLLABORATION_PLATFORM>
canonical_path: knowledge/applications/business-apps/collaboration-platform/index.md
summary: Collection index for curated seed content under Applications / Business Apps / <COLLABORATION_PLATFORM>.
...
source_title: Applications / Business Apps / <COLLABORATION_PLATFORM>
...
service_name: Applications / Business Apps / <COLLABORATION_PLATFORM>
...
- kb-applications-business-apps-collaboration-platform-collaboration-platform-monthly-audit-script
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/business-apps/collaboration-platform` content under the curated KMDB structure.

## Articles
- [Deleting Archived <COLLABORATION_PLATFORM> Users: Steps and Considerations for Restoration](deleting-archived-collaboration-platform-users-steps-and-considerations-for-restoration.md)
- [<COLLABORATION_PLATFORM> Monthly License Recovery](collaboration-platform-monthly-license-recovery.md)
- [<COLLABORATION_PLATFORM> Monthly audit script](collaboration-platform-monthly-audit-script.md)
