...
summary: <BUSINESS_APPLICATION_C> is a sales engagement platform that helps revenue teams automate and optimize their customer interactions. It enables users to manage email sequences, calls, and tasks in one place
type: reference
status: active
owner: service_owner
