---
id: kb-applications-business-apps-productivity-platform-index
title: Applications / Business Apps / <PRODUCTIVITY_PLATFORM>
canonical_path: knowledge/applications/business-apps/productivity-platform/index.md
summary: Collection index for curated seed content under Applications / Business Apps / <PRODUCTIVITY_PLATFORM>.
...
source_title: Applications / Business Apps / <PRODUCTIVITY_PLATFORM>
...
service_name: Applications / Business Apps / <PRODUCTIVITY_PLATFORM>
...
related_runbooks:
- kb-applications-business-apps-productivity-platform-productivity-platform-licensing-apps-e3-no-teams-and-teams-enterprise
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/business-apps/productivity-platform` content under the curated KMDB structure.

## Articles
- [<PRODUCTIVITY_PLATFORM> Licensing: Apps, standard tier (No messaging add-on), and messaging add-on](productivity-platform-licensing-core-and-messaging-tiers.md)
