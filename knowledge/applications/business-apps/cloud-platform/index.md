---
id: kb-applications-business-apps-cloud-platform-index
title: Applications / Business Apps / <CLOUD_PLATFORM>
canonical_path: knowledge/applications/business-apps/cloud-platform/index.md
summary: Collection index for curated seed content under Applications / Business Apps / <CLOUD_PLATFORM>.
...
source_title: Applications / Business Apps / <CLOUD_PLATFORM>
...
service_name: Applications / Business Apps / <CLOUD_PLATFORM>
...
related_runbooks:
- kb-applications-business-apps-cloud-platform-cloud-platform-access-requests
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/business-apps/<CLOUD_PLATFORM>` content under the curated KMDB structure.

## Articles
- [<CLOUD_PLATFORM> access requests](cloud-platform-access-requests.md)
