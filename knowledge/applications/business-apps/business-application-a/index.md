---
id: kb-applications-business-apps-business-application-a-index
title: Applications / Business Apps / <BUSINESS_APPLICATION_A>
canonical_path: knowledge/applications/business-apps/business-application-a/index.md
summary: Collection index for curated seed content under Applications / Business Apps / <BUSINESS_APPLICATION_A>.
...
source_title: Applications / Business Apps / <BUSINESS_APPLICATION_A>
...
service_name: Applications / Business Apps / <BUSINESS_APPLICATION_A>
...
- article_id: null
  ...
  integrity_hash: null
related_object_ids:
- kb-applications-business-apps-business-application-a-business-application-a-overview-access-guide
prerequisites:
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/business-apps/<BUSINESS_APPLICATION_A>` content under the curated KMDB structure.

## Articles
- [<BUSINESS_APPLICATION_A> - Overview & Access Guide](business-application-a-overview-access-guide.md)
