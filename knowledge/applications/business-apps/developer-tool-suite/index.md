---
id: kb-applications-business-apps-developer-tool-suite-index
title: Applications / Business Apps / <DEVELOPER_TOOL_SUITE>
canonical_path: knowledge/applications/business-apps/developer-tool-suite/index.md
summary: Collection index for curated seed content under Applications / Business Apps / <DEVELOPER_TOOL_SUITE>.
...
source_title: Applications / Business Apps / <DEVELOPER_TOOL_SUITE>
...
service_name: Applications / Business Apps / <DEVELOPER_TOOL_SUITE>
...
related_runbooks:
- kb-applications-business-apps-developer-tool-suite-adding-new-developer-tool-suite-licenses
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/business-apps/<DEVELOPER_TOOL_SUITE>` content under the curated KMDB structure.

## Articles
- [Adding new <DEVELOPER_TOOL_SUITE> licenses](adding-new-developer-tool-suite-licenses.md)
