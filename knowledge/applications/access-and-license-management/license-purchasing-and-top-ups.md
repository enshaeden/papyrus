...
Currently limited to <COLLABORATION_PLATFORM> and <PRODUCTIVITY_PLATFORM>, IT can and should purchase licensing as-needed. Licenses will arrive Just-in-time (JIT) according to the following processes:

[<INTERNAL_URL>](<INTERNAL_URL>)

[Add <PRODUCTIVITY_PLATFORM> Licenses Add <PRODUCTIVITY_PLATFORM> Licenses](add-productivity-platform-licenses.md)
