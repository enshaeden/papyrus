---
id: kb-applications-access-and-license-management-index
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `applications/access-and-license-management` content under the curated KMDB structure.

## Articles
- [Add <COLLABORATION_PLATFORM> advanced tier Licenses](add-collaboration-platform-advanced-tier-licenses.md)
- [Add <PRODUCTIVITY_PLATFORM> Licenses](add-productivity-platform-licenses.md)
- [App Owner Review Process — Master Ticket Route (<COMPANY_NAME> IT <ASSET_MANAGEMENT_SYSTEM>)](app-owner-review-process-application-catalog-route.md)
- [Application Ownership & Access Audit Playbook](application-ownership-access-audit-playbook.md)
- [IT Application Tracking & Access Management](it-application-tracking-access-management.md)
- [License Manager — Audit & Reclaim SOP](license-manager-audit-reclaim-sop.md)
- [License purchasing and top ups](license-purchasing-and-top-ups.md)
- [Managing <IDENTITY_PROVIDER> Access Requests & General App Requests](managing-identity-provider-access-requests-general-app-requests.md)
- [Software License Management](software-license-management.md)
