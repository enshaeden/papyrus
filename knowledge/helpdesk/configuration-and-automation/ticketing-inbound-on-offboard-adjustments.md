...
summary: This <TICKETING_SYSTEM> automation rule automatically applies Components (and in one case, assignee group routing ) to newly created issues in a specific <TICKETING_SYSTEM> project, based on keywords found in the issue Summary .
type: SOP
status: active
owner: service_owner
