...
summary: Interview loaner laptops are stored in the Mail Room at <OFFICE_SITE_C> primary office and are available exclusively to Recruiting, Hiring Managers, and IT .
type: asset
status: active
owner: service_owner
