...
summary: "This guide walks you through the account setup process for your Windows device preconfigured with Windows device enrollment Profile . Your device is registered and prepared \u2014 just sign in and follow a few steps."
type: asset
status: active
owner: service_owner
