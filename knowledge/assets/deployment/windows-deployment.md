...
summary: All Windows PCs are enrolled in <ENDPOINT_MANAGEMENT_PLATFORM> during initial setup, when the new hire selects "Work Account" and signs in with their <COMPANY_NAME> email .
type: asset
status: active
owner: service_owner
