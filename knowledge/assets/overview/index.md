---
id: kb-assets-overview-index
title: Assets / Overview
canonical_path: knowledge/assets/overview/index.md
summary: Collection index for curated seed content under Assets / Overview.
type: reference
status: active
owner: service_owner
source_type: derived
source_system: knowledge_portal
source_title: Assets / Overview
...
related_articles:
- kb-assets-overview-asset-management-overview
- kb-assets-overview-managing-it-hardware-and-software-at-company
replaced_by: null
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `assets/overview` content under the curated KMDB structure.

## Articles
- [Asset Management Overview](asset-management-overview.md)
- [Managing IT hardware and software at <COMPANY_NAME>](managing-it-hardware-and-software-at-company.md)
