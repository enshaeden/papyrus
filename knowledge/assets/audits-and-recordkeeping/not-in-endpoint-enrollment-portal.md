...
summary: To ensure all devices are properly accounted for in <ENDPOINT_ENROLLMENT_PORTAL>, a new automation has been implemented in <ASSET_MANAGEMENT_SYSTEM>. This automation tracks devices that are missing from <ENDPOINT_ENROLLMENT_PORTAL> and alerts the team when action is required.
type: asset
status: active
owner: service_owner
