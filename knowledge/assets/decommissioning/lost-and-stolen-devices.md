...
summary: In the event that a <COMPANY_NAME> asset is reported lost or stolen, it is imperative to act swiftly to mitigate any potential security risks. Adherence to the procedures outlined below is required.
type: asset
status: active
owner: service_owner
