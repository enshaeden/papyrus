...
summary: This document defines the standard process for securely decommissioning Windows device enrollment devices managed through <PRODUCTIVITY_PLATFORM> <ENDPOINT_MANAGEMENT_PLATFORM>. It ensures all company data is removed, devices are deregistered from management...
type: asset
status: active
owner: service_owner
