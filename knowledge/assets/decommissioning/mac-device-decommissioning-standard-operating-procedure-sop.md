...
summary: This document defines the standard process for securely decommissioning Mac devices managed through <ENDPOINT_MANAGEMENT_PLATFORM> and <ENDPOINT_ENROLLMENT_PORTAL>. It ensures all company data is removed, devices are deregistered from management...
type: asset
status: active
owner: service_owner
