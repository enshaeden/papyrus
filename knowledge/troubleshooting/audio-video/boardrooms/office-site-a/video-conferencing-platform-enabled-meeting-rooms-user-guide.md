...
summary: Welcome to the <ROOM_NAME_A>, <ROOM_NAME_B> and <ROOM_NAME_C> <VIDEO_CONFERENCING_PLATFORM> are
  fully equipped meeting space designed for seamless and professional video conferencing.
...
- Collaboration
symptoms:
- Welcome to the <ROOM_NAME_A>, <ROOM_NAME_B> and <ROOM_NAME_C> <VIDEO_CONFERENCING_PLATFORM> are fully
  equipped meeting space designed for seamless and professional video conferencing.
scope: 'Legacy source does not declare structured scope. Summary: Welcome to the <ROOM_NAME_A>, <ROOM_NAME_B>
  and <ROOM_NAME_C> <VIDEO_CONFERENCING_PLATFORM> are fully equipped meeting space designed for seamless
  and professional video conferencing.'
