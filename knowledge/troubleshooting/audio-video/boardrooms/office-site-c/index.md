---
id: kb-troubleshooting-audio-video-boardrooms-office-site-c-index
title: Troubleshooting / Audio and Video / Boardrooms / <OFFICE_SITE_C>
canonical_path: knowledge/troubleshooting/audio-video/boardrooms/office-site-c/index.md
summary: Collection index for curated seed content under Troubleshooting / Audio and Video / Boardrooms / <OFFICE_SITE_C>.
type: reference
status: active
owner: service_owner
source_type: derived
source_system: knowledge_portal
source_title: Troubleshooting / Audio and Video / Boardrooms / <OFFICE_SITE_C>
...
related_articles:
- kb-troubleshooting-audio-video-boardrooms-office-site-c-meeting-room-admin-guide-room-name-e
- kb-troubleshooting-audio-video-boardrooms-office-site-c-meeting-room-user-guide-room-name-e
replaced_by: null
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `troubleshooting/audio-video/boardrooms/seattle` content under the curated KMDB structure.

## Articles
- [Meeting Room Admin Guide - <ROOM_NAME_E>](meeting-room-admin-guide-room-name-e.md)
- [Meeting Room User Guide - <ROOM_NAME_E>](meeting-room-user-guide-room-name-e.md)
