---
id: kb-troubleshooting-device-index
title: Troubleshooting / Device
canonical_path: knowledge/troubleshooting/device/index.md
summary: Collection index for curated seed content under Troubleshooting / Device.
...
source_title: Troubleshooting / Device
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `troubleshooting/device` content under the curated KMDB structure.

## Child Collections
- [Troubleshooting / Device / Mac](mac/index.md)
