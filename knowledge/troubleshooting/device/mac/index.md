---
id: kb-troubleshooting-device-mac-index
title: Troubleshooting / Device / Mac
canonical_path: knowledge/troubleshooting/device/mac/index.md
summary: Collection index for curated seed content under Troubleshooting / Device / Mac.
...
source_title: Troubleshooting / Device / Mac
...
- kb-troubleshooting-device-mac-granting-users-administrative-permissions-on-their-mac-laptops
- kb-troubleshooting-device-mac-mac-lockout
citations:
- article_id: null
...
## Scope
This collection page was created during the <KNOWLEDGE_PORTAL> seed migration to organize `troubleshooting/device/mac` content under the curated KMDB structure.

## Articles
- [Granting users administrative permissions on their Mac laptops](granting-users-administrative-permissions-on-their-mac-laptops.md)
- [Mac Lockout](mac-lockout.md)
