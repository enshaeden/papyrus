...
def apply_runtime_schema(connection: sqlite3.Connection, has_fts5: bool) -> None:
    connection.executescript(
        ...
        CREATE TABLE IF NOT EXISTS knowledge_objects (
            ...
            source_sync_state TEXT NOT NULL DEFAULT 'not_required',
            source_sync_revision_id TEXT,
            source_sync_content_hash TEXT,
            source_sync_mutation_id TEXT,
