    ...
    *,
    ...
    for item in items:
        ...
        rows.append(
            ...
            f'<td><a class="selected-row-link" href="{escape(review_queue_url())}?selected_object_id={escape(object_id)}&selected_revision_id={escape(revision_id)}">{escape(item["title"])}</a></td>'
