...
from papyrus.interfaces.web.presenters.revision_audit_sequence_presenter import (
    render_revision_audit_sequence,
)
from papyrus.interfaces.web.presenters.revision_comparison_cues_presenter import (
    render_revision_comparison_cues,
)
