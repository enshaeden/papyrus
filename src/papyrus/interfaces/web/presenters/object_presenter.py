...
from papyrus.interfaces.web.view_helpers import join_html, link
...
def present_object_detail(renderer: TemplateRenderer, *, detail: dict[str, Any], experience: ExperienceContext) -> dict[str, Any]:
    ...
    return {
        ...
        "page_header": {
            "headline": "Inspect" if experience.role == ADMIN_ROLE else "Read",
            "kicker": experience.label,
            "intro": "Content-first object view" if experience.role == READER_ROLE else "Operational article view",
        },
