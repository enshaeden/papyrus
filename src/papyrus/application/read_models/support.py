    ...
    *,
    ...
    return RuntimeStateSnapshot(
        ...
        revision_review_state=(
            _revision_review_value(row) if row["revision_review_state"] is not None else None
        ),
        draft_progress_state=(
            _draft_progress_value(row) if row["draft_progress_state"] is not None else None
        ),
