...
| `GET` | `/admin/governance` | `admin` | `papyrus.interfaces.web.routes.dashboard.trust_dashboard_page` |
...
| `GET` | `/admin/review` | `admin` | `papyrus.interfaces.web.routes.manage.manage_queue_page` |
...
| `GET` | `/operator/review` | `operator` | `papyrus.interfaces.web.routes.manage.manage_queue_page` |
| `GET` | `/operator/review/activity` | `operator` | `papyrus.interfaces.web.routes.manage.audit_page` |
| `GET` | `/operator/review/governance` | `operator` | `papyrus.interfaces.web.routes.dashboard.trust_dashboard_page` |
...
| `GET, POST` | `/operator/write/new` | `operator` | `papyrus.interfaces.web.routes.write_object.create_object_page` |
